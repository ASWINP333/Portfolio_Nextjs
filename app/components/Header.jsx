...
const Header = () => {
  return (
    ...
    items-center justify-center gap-4'>
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mx-3 font-Ovo'>Hi! I'm Aswin P  <Image src={assets.hand_icon} alt='' 
        ...
        transition={{duration:0.9, delay:0.3}}
         className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
            Full Stack Developer In MERN</motion.h1> 
            <motion.p
            initial={{opacity:0}}
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                href="/Resume_Aswin_P.pdf" download 
